...
/**
 * Route-level error UI for all investee routes. Branches on the PortalError
 * `kind` to show the right affordance: 401 -> re-auth, 403 -> permission denied,
 * everything else -> retry.
 */
export default function InvesteeError({
  error,
  reset,
}: {
