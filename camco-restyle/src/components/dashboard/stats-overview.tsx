...
export function StatsOverview({
  ...
  // Camco accent tints: Midnight, Sky, destructive red, Aqua-teal.
  const items = [
    { label: "Total requests", value: stats.total, icon: FileStack, tone: "text-foreground" },
    { label: "Pending", value: stats.pending, icon: Clock, tone: "text-[#008FC3]" },
    { label: "Overdue", value: stats.overdue, icon: AlertTriangle, tone: "text-[#C0334E]" },
    { label: "Approved", value: stats.approved, icon: CheckCircle2, tone: "text-[#15808A]" },
  ];
